...
public class ArcaneTowerButton : TowerButton
{
    public ArcaneTowerButton()
    {
        base..ctor();
        return;
    }
    ...
    protected override void OnClick()
    {
        ...
        ((MageAdvancedClickable) base.menu.GetCurrentSelect().GetComponent("MageAdvancedClickable")).BuildArcane(clickable, base.menu.GetCurrentSelect().GetComponent<TowerBase>().GetSpent());
        base.menu.GetCurrentSelect().GetComponent<MageAdvancedClickable>().HideUpgradeRange("Arcane");
    ...
    private void OnMouseEnter()
    {
        ...
        base.menu.GetCurrentSelect().GetComponent<MageAdvancedClickable>().ShowUpgradeRange(vector, "Arcane");
        if (base.available == null)
        {
            goto Label_00AE;
        }
    ...
    private void Start()
    {
        ...
        base.available = (base.stage.GetGold() < GameSettings.GetTowerPrice("MageArcane")) == 0;
        this.CheckAvailable("MageArcane");
