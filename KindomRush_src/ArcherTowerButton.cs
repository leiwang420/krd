...
internal class ArcherTowerButton : TowerButton
{
    private Transform ghost;
    public Transform ghostPrefab;

    public ArcherTowerButton()
    {
        base..ctor();
        return;
    }
    ...
    protected override void OnClick()
    {
        ...
        ((BuildTerrainClickable) base.menu.GetCurrentSelect()).BuildArcher();
        base.menu.Hide();
    ...
    Label_0028:
        ...
        this.ghost.GetComponent<TowerGhost>().SetRange(GameSettings.GetTowerSetting("archer_level1", "range"));
        return;
    }
    ...
    private void Start()
    {
        ...
        base.ShowPrice();
        base.available = (base.stage.GetGold() < GameSettings.GetTowerPrice("ArcherLvl1")) == 0;
        this.CheckAvailable("ArcherLvl1");
