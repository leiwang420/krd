...
public class BarrackTowerButton : TowerButton
{
    private Transform ghost;
    public Transform ghostPrefab;

    public BarrackTowerButton()
    {
        base..ctor();
        return;
    }
    ...
    protected override void OnClick()
    {
        ...
        ((BuildTerrainClickable) base.menu.GetCurrentSelect()).BuildBarrack();
        base.menu.Hide();
    ...
    Label_005B:
        this.ShowTooltip("BarrackLvl1", 0);
        this.ShowGhost();
        return;
    }
    ...
    Label_0028:
        ...
        this.ghost.GetComponent<TowerGhost>().SetRange(GameSettings.GetTowerSetting("barrack_level1", "rangeRally"));
        return;
    }
    ...
    private void Start()
    {
        ...
        base.ShowPrice();
        base.available = (base.stage.GetGold() < GameSettings.GetTowerPrice("BarrackLvl1")) == 0;
        this.CheckAvailable("BarrackLvl1");
