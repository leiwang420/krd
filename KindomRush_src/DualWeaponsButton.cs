...
public class DualWeaponsButton : AbilityButton
{
    private BarrackBarbarianTower tower;

    public DualWeaponsButton()
    {
        base..ctor();
        return;
    }
    ...
    {
        if (this.tower.GetDualWeaponsLevel() != 3)
        {
            goto Label_0022;
        }
    ...
    protected override void OnClick()
    {
        ...
        if (this.tower.DualWeaponsLevelUp() == null)
        {
            goto Label_007F;
        }
        base.PlayEffectBuy();
        base.menu.GetCurrentSelect().GetComponent<TowerBase>().SetSpent(base.price);
        this.SetRanks("dualWeaponsPriceLevel");
        GameSoundManager.PlayBarrackBarbarianDoubleAxesTaunt();
        base.HideTooltip();
        if (this.tower.GetDualWeaponsLevel() == 3)
        {
            goto Label_0079;
        }
        this.ShowTooltip("Double Axe", this.tower.GetDualWeaponsLevel());
    Label_0079:
    ...
    {
        int num;
        num = this.tower.GetDualWeaponsLevel();
        if (num != 1)
        {
            goto Label_0120;
        }
    ...
    Label_0239:
        ...
        goto Label_03DE;
    Label_02D7:
        base.price = GameSettings.GetAbilityPrice("dualWeaponsPrice");
        if (base.available == null)
        {
            goto Label_0363;
        }
    ...
    private void Start()
    {
        ...
        if (this.tower.GetDualWeaponsLevel() < 1)
        {
            goto Label_00D9;
        }
        base.CheckAvailable("dualWeaponsPriceLevel");
        goto Label_00E4;
    Label_00D9:
        base.CheckAvailable("dualWeaponsPrice");
    Label_00E4:
        this.DisableMaxLevelPricetag();
        return;
    }
