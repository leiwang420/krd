...
public class HolyOrderButton : TowerButton
{
    public HolyOrderButton()
    {
        base..ctor();
        return;
    }
    ...
    protected override void OnClick()
    {
        ...
        base.menu.GetCurrentSelect().GetComponent<BarrackAdvancedClickable>().BuildHolyOrder(clickable);
        base.menu.GetCurrentSelect().GetComponent<BarrackAdvancedClickable>().HideUpgradeRange("HolyOrder");
    ...
    private void OnMouseEnter()
    {
        ...
        base.menu.GetCurrentSelect().GetComponent<BarrackAdvancedClickable>().ShowUpgradeRange(vector, "HolyOrder");
        if (base.available == null)
        {
            goto Label_00AE;
        }
    ...
    Label_00AE:
        this.ShowTooltip("BarrackPaladin", 0);
        return;
    }
    ...
    private void Start()
    {
        ...
        base.ShowPrice();
        base.available = (base.stage.GetGold() < GameSettings.GetTowerPrice("BarrackHolyOrder")) == 0;
        this.CheckAvailable("BarrackHolyOrder");
