...
internal class MageTowerButton : TowerButton
{
    private Transform ghost;
    public Transform ghostPrefab;

    public MageTowerButton()
    {
        base..ctor();
        return;
    }
    ...
    protected override void OnClick()
    {
        ...
        ((BuildTerrainClickable) base.menu.GetCurrentSelect()).BuildMage();
        base.menu.Hide();
    ...
    Label_0028:
        ...
        &vector2 = new Vector3(&vector.x, &vector.y + 15f, -800f);
        this.ghost = UnityEngine.Object.Instantiate(this.ghostPrefab, vector2, base.transform.rotation) as Transform;
        this.ghost.GetComponent<TowerGhost>().SetRange(GameSettings.GetTowerSetting("mage_level1", "range"));
        return;
    }
    ...
    private void Start()
    {
        ...
        base.ShowPrice();
        base.stage = GameObject.Find("Stage").GetComponent<StageBase>();
        base.available = (base.stage.GetGold() < GameSettings.GetTowerPrice("MageLvl1")) == 0;
        this.CheckAvailable("MageLvl1");
