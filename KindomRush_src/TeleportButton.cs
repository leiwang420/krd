...
public class TeleportButton : AbilityButton
{
    ...
    protected override void OnClick()
    {
        ...
        this.SetRanks("teleportPriceLevel");
        GameSoundManager.PlayMageArcaneTeleportTaunt();
        base.HideTooltip();
        if (base.ability.GetLevel() == 3)
        {
            goto Label_0084;
        }
        this.ShowTooltip("Teleport", base.ability.GetLevel());
    Label_0084:
    ...
    private void Start()
    {
        ...
        base.ability = base.menu.GetCurrentSelect().GetComponent("TeleportAbility") as TeleportAbility;
        ...
        base.CheckAvailable("teleportPriceLevel");
        goto Label_00EE;
    Label_00E3:
        base.CheckAvailable("teleportPrice");
    Label_00EE:
        this.DisableMaxLevelPricetag();
        return;
    }
