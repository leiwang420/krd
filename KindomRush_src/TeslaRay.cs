...
public class TeslaRay : Ray
{
    ...
    Label_00D7:
        if (this.jumpCurrent != 1)
        {
            goto Label_0134;
        }
    Label_00E3:
        base.minDamage = GameSettings.GetTowerSetting("artillery_tesla", "minDamage");
        base.maxDamage = GameSettings.GetTowerSetting("artillery_tesla", "maxDamage");
        this.SetDamage(Mathf.CeilToInt(UnityEngine.Random.Range(base.minDamage, base.maxDamage + 1f)));
        goto Label_01F5;
    Label_0134:
        if (this.jumpCurrent != 2)
        {
            goto Label_019D;
        }
        base.minDamage = GameSettings.GetTowerSetting("artillery_tesla", "minDamage") * 0.75f;
        base.maxDamage = GameSettings.GetTowerSetting("artillery_tesla", "maxDamage") * 0.75f;
        this.SetDamage(Mathf.CeilToInt(UnityEngine.Random.Range(base.minDamage, base.maxDamage + 1f)));
        goto Label_01F5;
    Label_019D:
        base.minDamage = GameSettings.GetTowerSetting("artillery_tesla", "minDamage") * 0.5f;
        base.maxDamage = GameSettings.GetTowerSetting("artillery_tesla", "maxDamage") * 0.5f;
        this.SetDamage(Mathf.CeilToInt(UnityEngine.Random.Range(base.minDamage, base.maxDamage + 1f)));
    Label_01F5:
        base.GetDamage();
        goto Label_020B;
