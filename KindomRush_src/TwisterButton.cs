...
public class TwisterButton : AbilityButton
{
    private BarrackBarbarianTower tower;

    public TwisterButton()
    {
        base..ctor();
        return;
    }
    ...
    {
        if (this.tower.GetTwisterLevel() != 3)
        {
            goto Label_0022;
        }
    ...
    protected override void OnClick()
    {
        ...
        if (this.tower.TwisterLevelUp() == null)
        {
            goto Label_007F;
        }
        base.PlayEffectBuy();
        base.menu.GetCurrentSelect().GetComponent<TowerBase>().SetSpent(base.price);
        this.SetRanks("twisterPriceLevel");
        GameSoundManager.PlayBarrackBarbarianTwisterTaunt();
        base.HideTooltip();
        if (this.tower.GetTwisterLevel() == 3)
        {
            goto Label_0079;
        }
        this.ShowTooltip("Twister", this.tower.GetTwisterLevel());
    Label_0079:
    ...
    {
        int num;
        num = this.tower.GetTwisterLevel();
        if (num != 1)
        {
            goto Label_0120;
        }
    ...
    Label_0239:
        ...
        goto Label_03DE;
    Label_02D7:
        base.price = GameSettings.GetAbilityPrice("twisterPrice");
        if (base.available == null)
        {
            goto Label_0363;
        }
    ...
    private void Start()
    {
        ...
        if (this.tower.GetTwisterLevel() < 1)
        {
            goto Label_00D9;
        }
        base.CheckAvailable("twisterPriceLevel");
        goto Label_00E4;
    Label_00D9:
        base.CheckAvailable("twisterPrice");
    Label_00E4:
        this.DisableMaxLevelPricetag();
        return;
    }
